...
def main() -> int:
    ...
    parser.add_argument("--log-dir", type=Path, default=REPOSITORY_ROOT / "data/collection_logs")
    parser.add_argument("--manifest", type=Path, default=REPOSITORY_ROOT / "data/r7_collection_manifest.json")
    ...
    parser.add_argument(
        "--collector",
        type=Path,
        default=Path(__file__).with_name("collect_isaaclab_anymal_trajectory.py"),
    )
